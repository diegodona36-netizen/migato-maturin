 ...
 */
import { detectParishFromGeometry } from "./geoMonagas.js?v=190";
import { CATALOGO_MONAGAS, findParishInCatalog } from "./catalogoMonagas.js?v=190";
import { GEO_PARROQUIAS_OFICIAL } from "./geoOficialMonagas.js?v=190";
import { CENTROS_MATURIN } from "./centrosData.js?v=190";
