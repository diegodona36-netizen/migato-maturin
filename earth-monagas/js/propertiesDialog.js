 ...
 */
import { detectParishFromGeometry } from "./geoMonagas.js?v=148";
import { CATALOGO_MONAGAS, findParishInCatalog } from "./catalogoMonagas.js?v=148";
import { GEO_PARROQUIAS_OFICIAL } from "./geoOficialMonagas.js?v=148";
import { CENTROS_MATURIN } from "./centrosData.js?v=148";
