 ...
 */
import { detectParishFromGeometry } from "./geoMonagas.js?v=220";
import { CATALOGO_MONAGAS, findParishInCatalog } from "./catalogoMonagas.js?v=220";
import { GEO_PARROQUIAS_OFICIAL } from "./geoOficialMonagas.js?v=220";
import { CENTROS_MATURIN } from "./centrosData.js?v=220";
