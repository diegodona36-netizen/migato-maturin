 ...
 */
import { detectParishFromGeometry } from "./geoMonagas.js?v=225";
import { CATALOGO_MONAGAS, findParishInCatalog } from "./catalogoMonagas.js?v=225";
import { GEO_PARROQUIAS_OFICIAL } from "./geoOficialMonagas.js?v=225";
import { CENTROS_MATURIN } from "./centrosData.js?v=225";
