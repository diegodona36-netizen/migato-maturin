 ...
 */
import { detectParishFromGeometry } from "./geoMonagas.js?v=195";
import { CATALOGO_MONAGAS, findParishInCatalog } from "./catalogoMonagas.js?v=195";
import { GEO_PARROQUIAS_OFICIAL } from "./geoOficialMonagas.js?v=195";
import { CENTROS_MATURIN } from "./centrosData.js?v=195";
