 ...
 */
import { GEO_ESTADO_OFICIAL, GEO_MUNICIPIOS_OFICIAL, GEO_PARROQUIAS_OFICIAL } from "./geoOficialMonagas.js?v=142";
import { CATALOGO_MONAGAS, PARISH_ALIAS_MAP, resolveParishId } from "./catalogoMonagas.js?v=142";
import { MONAGAS_DEMOGRAPHICS, getParishDemographics } from "./monagasDemographics.js?v=142";
...
export class EarthMapEngine {
  ...
  getMunicipioStats(munId) {
    ...
    const munObj = (typeof CATALOGO_MONAGAS !== "undefined" ? CATALOGO_MONAGAS : []).find(m => {
      ...
      return mId === cleanId || mId.includes(cleanId) || cleanId.includes(mId);
    });
