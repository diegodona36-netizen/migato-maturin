...
/**
 * Obtiene las variables estadísticas oficiales de una parroquia con respaldo automático
 */
export function getParishDemographics(munId, parishId) {
  if (!parishId) return null;
  const found = MONAGAS_DEMOGRAPHICS[parishId];
  if (found) return found;
  // Fallback genérico municipal
  return {
    nombre: parishId,
    munId: munId || "maturin",
    casas: 3500,
